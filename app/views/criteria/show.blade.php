...
<div class="alert alert-info alert-bold-border fade in alert-dismissable text-center">
    <strong>There is no subcriterion. {{ HTML::link('subcriteria/create/'.$id, 'Add subcriterion?', array('class'=>'alert-link')) }}</strong>
    <br />	
</div>
@else
<div class="row">
                ...
                <table class="table table-info table-hover table-th-block">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<div class="btn-group">
	                                <a class="btn btn-info btn-sm" href="{{ URL::to('subcriteria/'.$value->subcriterion_id.'/edit/'.$id) }}" title="Edit subcriterion">
	                                    ...
	                                    <div class="modal-dialog">
	                                        <div class="modal-content">
	                                            ...
	                                            <div class="modal-footer">
	                                                ...
	                                                {{ Form::open(array('url'=>'subcriteria/'.$value->subcriterion_id.'/'.$id, 'method'=>'DELETE',)) }}
